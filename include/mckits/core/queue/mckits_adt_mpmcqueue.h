#ifndef MKITS_INCLUDE_MCKITS_CORE_QUEUE_MCKITS_ADT_MPMCQUEUE_H_
#define MKITS_INCLUDE_MCKITS_CORE_QUEUE_MCKITS_ADT_MPMCQUEUE_H_
...
#endif  // MKITS_INCLUDE_MCKITS_CORE_QUEUE_MCKITS_ADT_MPMCQUEUE_H_
