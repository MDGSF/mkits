#ifndef MKITS_INCLUDE_MCKITS_CORE_QUEUE_MCKITS_FLOWQUEUE_H_
#define MKITS_INCLUDE_MCKITS_CORE_QUEUE_MCKITS_FLOWQUEUE_H_
...
#endif  // MKITS_INCLUDE_MCKITS_CORE_QUEUE_MCKITS_FLOWQUEUE_H_
